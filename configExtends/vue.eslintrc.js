module.exports = {
    ...
    rules: {
        ...
        // "@typescript-eslint/require-await" // 禁止没有await表达式的异步函数
        // "@typescript-eslint/space-before-function-paren": ["error"], // 在函数括号之前强制保持一致的间距
        // "@typescript-eslint/no-extra-parens": ["error"], // 禁止不必要的括号
        // "@typescript-eslint/no-extra-semi": ["error"], // 禁止不必要的分号
        // "@typescript-eslint/keyword-spacing": ["error"], // 在关键字前后强制保持一致的间距
        ...
        'no-undef': ['error', {typeof: true}], // 不能有未定义的变量
